...
# Run the application
echo "=========================================="
echo "Starting the Complete AI Risk Repository Chatbot"
echo "This version uses ALL backend components:"
echo "- Vector Store with hybrid search"
echo "- Query Monitor for domain detection"
echo "- Gemini Model for LLM response generation"
echo "=========================================="
echo "Access the application at: http://localhost:$PORT"

$PYTHON_CMD complete_adapter.py