...
# Run the application
echo "=========================================="
echo "Starting the FINAL AI Risk Repository Chatbot"
echo "This version properly adapts to the actual backend component interfaces"
echo "and uses ALL backend components with robust error handling"
echo "=========================================="
echo "Access the application at: http://localhost:$PORT"

$PYTHON_CMD final_adapter.py